...
<div class="homepage__columns">
	<div class="hpl hp-box -left">
		...
		<div class="_toggle">Engineered wood flooring</div>
		<div class="_content">
			<div class="_first">
			...
			<div class="_second">
				...
				<a href="<?php echo get_permalink(11) ?>" class="_button">Read more</a>	
			</div>
		</div>
	</div>
	<div class="hpr hp-box -right">
		...
		<div class="_toggle">Solid wood flooring</div>
		<div class="_content">
			<div class="_first">
			...
			<div class="_second">
				...
				<a href="<?php echo get_permalink(6) ?>" class="_button">Read more</a>	
			</div>
		</div>
	</div>
</div>
